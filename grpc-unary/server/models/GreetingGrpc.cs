...
namespace Greet {
  public static partial class GreetingSerivce
  {
    static readonly string __ServiceName = "greet.GreetingSerivce";
    ...
    /// <summary>Base class for server-side implementations of GreetingSerivce</summary>
    [grpc::BindServiceMethod(typeof(GreetingSerivce), "BindService")]
    public abstract partial class GreetingSerivceBase
    {
      [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
    ...
    /// <summary>Client for GreetingSerivce</summary>
    public partial class GreetingSerivceClient : grpc::ClientBase<GreetingSerivceClient>
    {
      /// <summary>Creates a new client for GreetingSerivce</summary>
      /// <param name="channel">The channel to use to make remote calls.</param>
      [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
      public GreetingSerivceClient(grpc::ChannelBase channel) : base(channel)
      {
      }
      /// <summary>Creates a new client for GreetingSerivce that uses a custom <c>CallInvoker</c>.</summary>
      /// <param name="callInvoker">The callInvoker to use to make remote calls.</param>
      [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
      public GreetingSerivceClient(grpc::CallInvoker callInvoker) : base(callInvoker)
      {
      }
      /// <summary>Protected parameterless constructor to allow creation of test doubles.</summary>
      [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
      protected GreetingSerivceClient() : base()
      {
      }
      /// <summary>Protected constructor to allow creation of configured clients.</summary>
      /// <param name="configuration">The client configuration.</param>
      [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
      protected GreetingSerivceClient(ClientBaseConfiguration configuration) : base(configuration)
      {
      }
      ...
      [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
      protected override GreetingSerivceClient NewInstance(ClientBaseConfiguration configuration)
      {
        return new GreetingSerivceClient(configuration);
      }
    }
    ...
    [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
    public static grpc::ServerServiceDefinition BindService(GreetingSerivceBase serviceImpl)
    {
    ...
    /// <param name="serviceImpl">An object implementing the server-side handling logic.</param>
    [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
    public static void BindService(grpc::ServiceBinderBase serviceBinder, GreetingSerivceBase serviceImpl)
    {
